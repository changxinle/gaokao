...
//https://api.eol.cn/web/api/?local_province_id=41&page=1&school_id=62&size=10&uri=apidata/api/gk/score/province&year=2021
//     .then(async () => {
...
let total;
const size = 30;
const uri = "apidata/api/gk/score/province"
let page = 1;
let local_province_id =41;
let year = 2018;
// school_id
